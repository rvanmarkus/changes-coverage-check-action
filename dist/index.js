...
function transformFilenameInCoverageReport(filename) {
    return path_1.default.join(defaultPrefix, filename);
}
...
function getDiff() {
    const diffString = fs_1.default
        .readFileSync(path_1.default.join(basePath, defaultDiffFile))
        .toString();
    return (0, parse_diff_1.default)(diffString);
}
